...
parser.add_argument("--seed", type=int, default=12345, help="seed number for reproduction")
...
def load_keywords(lang_code=args.lang_code):
    keywords_file = os.path.join("crawler", "config", "keywords", f"{lang_code}.csv")
    keywords = pd.read_csv(keywords_file)["keyword"].str.lower().tolist()
...
if __name__ == '__main__':
    ...
    output_dir_lang = os.path.join(results_dir, args.lang_code)
