...
parser.add_argument('--load_from', type=str, default='output/models/ETM/',
...
save_path = f"output/models/ETM/{args.lang_code}"
...
if not args.train_embeddings:
    ...
    # vect_path = os.path.join(data_path.split('/')[0], 'embeddings.pkl')
    vectors = {}
    for word in vocab:
